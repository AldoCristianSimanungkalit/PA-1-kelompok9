            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="kategori" class="form-control" required>
                        <option value="Balige" {{ $galeri->kategori == 'Tele' ? 'selected' : '' }}>Tele</option>
                        <option value="Meat" {{ $galeri->kategori == 'Efrata' ? 'selected' : '' }}>Efrata</option>
                        <option value="Batu Bahisan" {{ $galeri->kategori == 'Sihotang' ? 'selected' : '' }}>Sihotang</option>
                    </select>
                </div>
